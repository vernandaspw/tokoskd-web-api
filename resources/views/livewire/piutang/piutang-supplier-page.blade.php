    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Piutang (Hutang supplier) <a href="{{ url('piutang', []) }}" class="btn mr-2 btn-secondary">Kembali</a></h1>

                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ url('/') }}">Home</a></li>
                            <li class="breadcrumb-item active">Piutang supplier</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <section class="content mb-3">
                    ...
                    <div class="col-md-3">
                        ...
                        ">
                            <div class="card-header">
                                Total Piutang (piutang supplier)
                            </div>
                            <div class="card-body">
            ...
            <div class="mb-5">
                ...
                <div class="col-md-3">
                    ...
                    <div class="">
                        <form wire:submit.prevent='tambah'>
                            <div class="mb-2">
                                <label class="mb-0"  for="">supplier</label>
                                <input type="text" disabled wire:model='d_nama' class="form-control" name="" id="">
                            </div>
                            <div class="">
                                <label class="mb-0" for="">Hutang supplier</label>
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Data piutang (utang supplier)</h3>
                    ...
                    @if($takeSupplier <= $supplier->count())
