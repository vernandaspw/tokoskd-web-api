    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Hutang saya ke supplier <a href="{{ url('hutang', []) }}" class="btn mr-2 btn-secondary">Kembali</a></h1>

                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ url('/') }}">Home</a></li>
                            <li class="breadcrumb-item active">Hutang ke supplier</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <section class="content mb-3">
            ...
            <div class="mb-5">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Data hutang ke supplier</h3>
