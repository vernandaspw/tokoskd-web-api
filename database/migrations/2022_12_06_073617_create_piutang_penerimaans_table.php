...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('piutang_penerimaans', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('kategori', ['piutang penjualan', 'retur penjualan', 'lainnya']);
    ...
    {
        Schema::dropIfExists('piutang_penerimaans');
    }
};
