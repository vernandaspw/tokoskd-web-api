...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('penjualan_retur_items', function (Blueprint $table) {
            $table->id();
            $table->foreignId('penjualan_retur_id')->constrained('penjualan_returs')->onUpdate('cascade')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('penjualan_retur_items');
    }
};
